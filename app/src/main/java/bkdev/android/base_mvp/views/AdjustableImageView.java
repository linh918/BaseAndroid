...
public class AdjustableImageView extends AppCompatImageView {
    ...
    public AdjustableImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AdjustableImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
